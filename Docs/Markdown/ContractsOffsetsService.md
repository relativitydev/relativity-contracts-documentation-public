...
To update the offsets on a document, the user making the request must have Object and Item Level permissions to Edit the document.
...
To delete an offset on a document, the user making the request must have Object and Item Level permissions to Edit the document.
